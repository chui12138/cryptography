<?php
	$alice = $_POST["text"];
	$ml = '/usr/java/jdk-15.0.1/bin/java -jar RSA.jar '.$alice.' && echo "NzM3NTYzNjM2NTczNzM=" '; 
	$info = shell_exec($ml);
...
<body>
    ...
    <form class="layui-form" action="RSA.php" method="post">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block" style="margin-right: 20px;margin-top: 20px;">
                ...
                <div></div>
            	<a href="RSA.html" class="layui-btn" >返回</a>
            </div>
        </div>
</body>
