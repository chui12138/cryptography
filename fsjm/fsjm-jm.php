<?php
	$alice = $_POST["text"];
	$key = $_POST["num"];
	$ml = "./fsjm 1 ".$alice.' '.$key.'&& echo "NzM3NTYzNjM2NTczNzM=" '; 
	$info = shell_exec($ml);
...
<body>
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
        <legend>仿射加密解密结果</legend>
    </fieldset>
    <form class="layui-form" action="fsjm.php" method="post">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block" style="margin-right: 20px;margin-top: 20px;">
                ...
                <div></div>
            	<a href="fsjm-jm.html" class="layui-btn" >返回</a>
            </div>
        </div>
</body>
